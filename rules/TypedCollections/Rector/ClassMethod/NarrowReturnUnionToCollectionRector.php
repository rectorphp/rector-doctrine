...
final class NarrowReturnUnionToCollectionRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Narrow union type to Collection type in method docblock', [
            new CodeSample(
                <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        return array_any($unionType->types, fn(Identifier|IntersectionType|Name $unionedType): bool => $this->isName($unionedType, DoctrineClass::COLLECTION));
    }
}
