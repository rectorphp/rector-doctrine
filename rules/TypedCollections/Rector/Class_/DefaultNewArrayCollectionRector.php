...
final class DefaultNewArrayCollectionRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Add default new ArrayCollection() to collection typed properties', [
            new CodeSample(
                <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Class_
    {
        ...
        if ($constructorClassMethod instanceof ClassMethod) {
            $constructorClassMethod->stmts = array_merge(
                (array) $constructorClassMethod->stmts,
