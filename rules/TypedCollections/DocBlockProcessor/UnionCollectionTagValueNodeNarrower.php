...
final class UnionCollectionTagValueNodeNarrower
{
    public function narrow(
        ReturnTagValueNode|ParamTagValueNode|VarTagValueNode $tagValueNode,
        bool $hasNativeCollectionType = false
    ): bool {
    ...
    {
        return array_any($complexTypeNode->types, fn(TypeNode $typeNode): bool => $this->isCollectionIdentifierTypeNode($typeNode));
    }
