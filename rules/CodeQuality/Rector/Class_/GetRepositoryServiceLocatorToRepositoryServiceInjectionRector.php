...
final class GetRepositoryServiceLocatorToRepositoryServiceInjectionRector extends AbstractRector
{
    ...
    public function __construct(
        ...
        private readonly RepositoryClassResolver $repositoryClassResolver,
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Class_
    {
        ...
        $this->traverseNodesWithCallable($node->stmts, function (Node $node) use (
            ...
            $fetchedEntityValue = $node->getArgs()[0]
                ->value;
            ...
            $repositoryPropertyMetadatas[] = new PropertyMetadata(
                $repositoryVariableName,
                new FullyQualifiedObjectType($repositoryClass)
            );
