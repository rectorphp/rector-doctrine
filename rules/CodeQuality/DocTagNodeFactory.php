...
final class DocTagNodeFactory
{
     ...
     */
    public static function createSpacelessPhpDocTagNode(
        array $arrayItemNodes,
        string $className
    ): SpacelessPhpDocTagNode {
        $columDoctrineAnnotationTagValueNode = new DoctrineAnnotationTagValueNode(
            new IdentifierTypeNode('@\\' . $className),
            null,
            $arrayItemNodes
        );
