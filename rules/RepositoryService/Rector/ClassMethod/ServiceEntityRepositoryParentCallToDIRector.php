...
namespace Rector\Doctrine\RepositoryService\Rector\ClassMethod;
...
use Rector\Doctrine\Enum\OrmClass;
use Rector\Doctrine\RepositoryService\NodeFactory\RepositoryNodeFactory;
use Rector\Doctrine\RepositoryService\Type\RepositoryTypeFactory;
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if (! $classReflection->isSubclassOf(OrmClass::SERVICE_REPOSITORY_CLASS)) {
            return null;
        }
        ...
        $entityManagerObjectType = new ObjectType(OrmClass::ENTITY_MANAGER_INTERFACE);
    ...
    {
        $repositoryProperty = $class->getProperty('repository');
