...
final class SetParametersArrayToCollectionRector extends AbstractRector
{
    ...
    public function changeArrayToCollection(array $stmts, Variable $variable): bool
    {
        ...
        foreach ($stmts as $stmt) {
            ...
            if (
                ...
                $newCollection->args = [new Arg(new Array_(
                    $this->convertArrayToParameters($stmt->expr->expr)['parameters']
                ))];
    ...
    private function getAffectedVariables(ClassMethod $classMethod): iterable
    {
        ...
        foreach ($statements as $statement) {
            if (
                ...
                && $this->isName($statement->expr->name, 'setParameters')
    ...
    private function refactorMethodCall(MethodCall $methodCall): Node|null
    {
        ...
        [
            ...
            'changedParameterType' => $changedParameterType
        ] = $this->convertArrayToParameters($currentArg);
