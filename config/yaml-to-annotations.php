...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->when(YamlToAnnotationTransformer::class)
        ->needs('$classAnnotationTransformers')
        ->giveTagged(ClassAnnotationTransformerInterface::class);

    $rectorConfig->when(YamlToAnnotationTransformer::class)
        ->needs('$propertyAnnotationTransformers')
        ->giveTagged(PropertyAnnotationTransformerInterface::class);
};
