...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if ($this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PrePersistEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PreUpdateEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PreRemoveEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PostPersistEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PostUpdateEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PostRemoveEventArgs')) ||
            $this->isObjectType($node, new ObjectType('Doctrine\ORM\Event\PostLoadEventArgs'))) {
            return null;
        }
